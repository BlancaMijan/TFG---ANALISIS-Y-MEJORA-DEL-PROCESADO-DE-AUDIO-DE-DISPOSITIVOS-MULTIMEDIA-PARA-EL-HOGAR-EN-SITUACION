...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% PUERTA DE RUIDO LINEAL BASADA EN LOUDNESS %%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Esta función aplica la Puerta de Ruido Lineal basada en LOUDNESS.
...
function [PR_L_LOUDNESS] = PR_L_LOUDNESS(muestra, fs, LOUDNESSnormal)
    ...
    while fin_loudness < tope
        ...
        if contador == 1
            ...
            if LOUDNESSventana < Umbral 
                % Aplico la Puerta de Ruido Lineal basada en LOUDNESS.   
                PR_L_LOUDNESS(inicio_aplicacion:fin_aplicacion,1) = PR_L_LOUDNESS(inicio_aplicacion:fin_aplicacion,1)*Re-Te*(Re-1);
            ...
            LOUDNESSventana = acousticLoudness(PR_L_LOUDNESS(inicio_loudness:fin_loudness,1), fs);
            % Si el LOUDNESS calculado en la ventana está por debajo del Umbral 
            % marcado, aplico la Puerta de Ruido. 
            if LOUDNESSventana < Umbral 
                % Aplico la Puerta de Ruido Lineal basada en LOUDNESS. 
