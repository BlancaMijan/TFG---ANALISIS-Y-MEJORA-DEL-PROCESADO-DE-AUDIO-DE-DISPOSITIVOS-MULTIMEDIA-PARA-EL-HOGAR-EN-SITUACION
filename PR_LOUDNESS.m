...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%% PUERTA DE RUIDO BASADA EN LOUDNESS %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Esta función aplica la Puerta de Ruido basada en LOUDNESS.
% En este caso, la Puerta de Ruido basada en LOUDNESS se activará cuando el
% LOUDNESSventana se encuentre sustancialmente por debajo del LOUDNESSnormal. 
% Cuando se active, a las muestras pertenecientes a esa ventana se las
% multiplicará por una ganancia positiva, pero menor que 0 para disminuir su
% nivel.

function [PR_LOUDNESS] = PR_LOUDNESS(muestra, fs, LOUDNESSnormal)
    ...
    while fin_loudness < tope
        ...
        if contador == 1
            ...
            if LOUDNESSventana < Umbral 
                ...
                PR_LOUDNESS(inicio_aplicacion:fin_aplicacion,1) = PR_LOUDNESS(inicio_aplicacion:fin_aplicacion,1)*G;
            ...
            LOUDNESSventana = acousticLoudness(PR_LOUDNESS(inicio_loudness:fin_loudness,1), fs);
            % Si el LOUDNESS calculado en la ventana está por debajo del Umbral 
            % marcado, aplico la Puerta de Ruido. 
            if LOUDNESSventana < Umbral 
                % Aplico la Puerta de Ruido basada en LOUDNESS. 
