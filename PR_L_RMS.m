...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%% PUERTA DE RUIDO LINEAL BASADA EN RMS %%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Esta función aplica la Puerta de Ruido Lineal basada en RMS.
% Esta Puerta de Ruido Lineal aplica la misma filosofía que una Puerta
...
function [PR_L_RMS] = PR_L_RMS(muestra, fs, RMSnormal)
    ...
    while fin_rms < tope
        ...
        if contador == 1
            ...
            if RMSventana < Umbral   
                % Aplico la Puerta de Ruido Lineal basada en RMS. 
                PR_L_RMS(inicio_aplicacion:fin_aplicacion,1) = (PR_L_RMS(inicio_aplicacion:fin_aplicacion,1)*Re)-(Te*(Re-1));
            ...
            RMSventana = rms(PR_L_RMS(inicio_rms:fin_rms,1));
            % Si el RMS calculado en la ventana está por debajo del Umbral 
            % marcado, aplico la Puerta de Ruido.   
            if RMSventana < Umbral 
                % Aplico la Puerta de Ruido Lineal basada en RMS. 
