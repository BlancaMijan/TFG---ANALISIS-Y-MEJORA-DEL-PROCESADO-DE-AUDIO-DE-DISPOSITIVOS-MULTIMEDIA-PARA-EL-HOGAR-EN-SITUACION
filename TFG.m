...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%% PUERTA DE RUIDO DE GANANCIA CONSTANTE %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Aplicación del algoritmo de Puerta de Ruido de Ganancia Constante basada 
% en RMS.
SilencioLargo_1_PR_GC_RMS = PR_GC_RMS(SilencioLargo_1, FsSilencioLargo_1, RMSnormal);
SilencioLargo_2_PR_GC_RMS = PR_GC_RMS(SilencioLargo_2, FsSilencioLargo_2, RMSnormal);
SilencioLargo_3_PR_GC_RMS = PR_GC_RMS(SilencioLargo_3, FsSilencioLargo_3, RMSnormal);

% Prueba de escucha.
% ap = audioplayer(SilencioLargo_1_PR_GC_RMS, FsSilencioLargo_1);
% playblocking(ap);

% Prueba de plots.
% figure(18)
% plot(SilencioLargo_1_PR_GC_RMS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 1 con PR GC RMS')
% 
% figure(19)
% plot(SilencioLargo_2_PR_GC_RMS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 2 con PR GC RMS')
% 
% figure(20)
% plot(SilencioLargo_3_PR_GC_RMS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 3 con PR GC RMS')

% Exportación de las señales de audio.
% audiowrite('SilencioLargo_1_PR_GC_RMS.wav',SilencioLargo_1_PR_GC_RMS,FsSilencioLargo_1);
% audiowrite('SilencioLargo_2_PR_GC_RMS.wav',SilencioLargo_2_PR_GC_RMS,FsSilencioLargo_2);
% audiowrite('SilencioLargo_3_PR_GC_RMS.wav',SilencioLargo_1_PR_GC_RMS,FsSilencioLargo_3);

%%%%%%%%%%%%%%%%%%%%%%%%%% BASADA EN LOUDNESS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% La idea de funcionamiento es la misma que en PR_GC_RMS, pero en vez de
...
SilencioLargo_1_PR_GC_LOUDNESS = PR_GC_LOUDNESS(SilencioLargo_1, FsSilencioLargo_1, LOUDNESSnormal);
SilencioLargo_2_PR_GC_LOUDNESS = PR_GC_LOUDNESS(SilencioLargo_2, FsSilencioLargo_2, LOUDNESSnormal);
SilencioLargo_3_PR_GC_LOUDNESS = PR_GC_LOUDNESS(SilencioLargo_3, FsSilencioLargo_3, LOUDNESSnormal);

% Prueba de escucha.
% ap = audioplayer(SilencioLargo_2_PR_GC_LOUDNESS, FsSilencioLargo_2);
% playblocking(ap);

% Prueba de plot.
% figure(21)
% plot(SilencioLargo_1_PR_GC_LOUDNESS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 1 con PR GC LOUDNESS')
% 
% figure(22)
% plot(SilencioLargo_2_PR_GC_LOUDNESS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 2 con PR GC LOUDNESS')
% 
% figure(23)
% plot(SilencioLargo_3_PR_GC_LOUDNESS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 3 con PR GC LOUDNESS')

% Exportación de las señales de audio.
% audiowrite('SilencioLargo_1_PR_GC_LOUDNESS.wav',SilencioLargo_1_PR_GC_LOUDNESS,FsSilencioLargo_1);
% audiowrite('SilencioLargo_2_PR_GC_LOUDNESS.wav',SilencioLargo_2_PR_GC_LOUDNESS,FsSilencioLargo_2);
% audiowrite('SilencioLargo_3_PR_GC_LOUDNESS.wav',SilencioLargo_1_PR_GC_LOUDNESS,FsSilencioLargo_3);

%%%%%%%%%%%%%%%%%%%%%%%%% LINEAL BASADA EN RMS %%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Este tipo de Puerta de Ruido aplica la misma filosofía que una Puerta
% de Ruido de Ganancia Constante cambiando la forma en la que se 
% decrementan los niveles que se encuentran por debajo del Umbral. 
...
% Aplicación del algoritmo de Puerta de Ruido Lineal basada en RMS.
SilencioLargo_1_PR_L_RMS = PR_L_RMS(SilencioLargo_1, FsSilencioLargo_1, RMSnormal);
SilencioLargo_2_PR_L_RMS = PR_L_RMS(SilencioLargo_2, FsSilencioLargo_2, RMSnormal);
SilencioLargo_3_PR_L_RMS = PR_L_RMS(SilencioLargo_3, FsSilencioLargo_3, RMSnormal);

% Prueba de escucha.
% ap = audioplayer(SilencioLargo_1_PR_L_RMS, FsSilencioLargo_1);
% playblocking(ap);

% Prueba de plot.
% figure(24)
% plot(SilencioLargo_1_PR_L_RMS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 1 con PR L RMS')
% 
% figure(25)
% plot(SilencioLargo_2_PR_L_RMS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 2 con PR L RMS')
% 
% figure(26)
% plot(SilencioLargo_3_PR_L_RMS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 3 con PR L RMS')

% Exportación de las señales de audio.
% audiowrite('SilencioLargo_1_PR_L_RMS.wav',SilencioLargo_1_PR_L_RMS,FsSilencioLargo_1);
% audiowrite('SilencioLargo_2_PR_L_RMS.wav',SilencioLargo_2_PR_L_RMS,FsSilencioLargo_2);
% audiowrite('SilencioLargo_3_PR_L_RMS.wav',SilencioLargo_1_PR_L_RMS,FsSilencioLargo_3);

%%%%%%%%%%%%%%%%%%%% LIENAL BASADA EN LOUDNESS %%%%%%%%%%%%%%%%%%%%%%%%%

% Este tipo de Puerta de Ruido aplica la misma filosofía que una Puerta
% de Ruido Lineal basada en RMS, pero usando como Umbral la comparación 
% del LOUDNESSnormal con el LOUDNESSventana.

% Aplicación del algoritmo de Puerta de Ruido Lineal basada en LOUDNESS.
SilencioLargo_1_PR_L_LOUDNESS = PR_L_LOUDNESS(SilencioLargo_1, FsSilencioLargo_1, LOUDNESSnormal);
SilencioLargo_2_PR_L_LOUDNESS = PR_L_LOUDNESS(SilencioLargo_2, FsSilencioLargo_2, LOUDNESSnormal);
SilencioLargo_3_PR_L_LOUDNESS = PR_L_LOUDNESS(SilencioLargo_3, FsSilencioLargo_3, LOUDNESSnormal);

% Prueba de escucha.
% ap = audioplayer(SilencioLargo_3_PR_L_LOUDNESS, FsSilencioLargo_3);
% playblocking(ap);

% Prueba de plot.
% figure(27)
% plot(SilencioLargo_1_PR_L_LOUDNESS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 1 con PR L LOUDNESS')
% 
% figure(28)
% plot(SilencioLargo_2_PR_L_LOUDNESS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 2 con PR L LOUDNESS')
% 
% figure(29)
% plot(SilencioLargo_3_PR_L_LOUDNESS)
% xlabel('Número de muestras')
% ylabel('Amplitud')
% title('Señal Silencios Largos 3 con PR L LOUDNESS')

% Exportación de las señales de audio.
% audiowrite('SilencioLargo_1_PR_L_LOUDNESS.wav',SilencioLargo_1_PR_L_LOUDNESS,FsSilencioLargo_1);
% audiowrite('SilencioLargo_2_PR_L_LOUDNESS.wav',SilencioLargo_2_PR_L_LOUDNESS,FsSilencioLargo_2);
% audiowrite('SilencioLargo_3_PR_L_LOUDNESS.wav',SilencioLargo_1_PR_L_LOUDNESS,FsSilencioLargo_3);
