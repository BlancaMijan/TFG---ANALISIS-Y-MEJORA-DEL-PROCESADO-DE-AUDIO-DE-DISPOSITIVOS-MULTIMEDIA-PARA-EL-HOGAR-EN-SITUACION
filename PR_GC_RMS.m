...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%% PUERTA DE RUIDO BASADA DE GANANCIA CONSTANTE EN RMS %%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Esta función aplica la Puerta de Ruido de Ganancia Constante basada en RMS.
% En este caso, la Puerta de Ruido de Ganancia Constante basada en RMS se 
% activará cuando el RMSventana se encuentre sustancialmente por debajo del 
% RMSnormal. Cuando se active, a las muestras pertenecientes a esa ventana 
% se las multiplicará por una ganancia positiva, pero menor que 0, para 
% disminuir su nivel.

function [PR_GC_RMS] = PR_GC_RMS(muestra, fs, RMSnormal)
    ...
    while fin_rms < tope
        ...
        if contador == 1
            ...
            if RMSventana < Umbral
                % Aplico la Puerta de Ruido de Ganancia Constante basada en RMS. 
                PR_GC_RMS(inicio_aplicacion:fin_aplicacion,1) = PR_GC_RMS(inicio_aplicacion:fin_aplicacion,1)*G;
            ...
            RMSventana = rms(PR_GC_RMS(inicio_rms:fin_rms,1));
            % Si el RMS calculado en la ventana está por debajo del Umbral 
            % marcado, aplico la Puerta de Ruido.      
            if RMSventana < Umbral
                % Aplico la Puerta de Ruido de Ganancia Constante basada en RMS. 
