...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%% FUNCIÓN CONTROL DE GANANCIA BASADO EN EL LOUDNESS %%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Esta función aplica el Control de Ganancia basado en el LOUDNESS.

function [CG_LOUDNESS] = CG_LOUDNESS(muestra, fs, LOUDNESSnormal)
    ...
    % tramo en el que tengo que aplicar el Loudness previamente calculado.
    % Voy a suponer que mientras que estoy calculando el Loudness
    ...
    while fin_ganancia < tope
        ...
        if contador == 1
            ...
            % Si el LODUNESS calculado en la ventana es mayor que el LOUDNESSnormal.
            if LOUDNESSventana > LOUDNESSnormal
                % Se calcula la diferencia de proporciones de LOUDNESSs, que será 
                % mi Ganancia a aplicar.
                Ganancia = LOUDNESSventana/LOUDNESSnormal;
                % Se aplica la Ganancia dividiendo para "bajar" los niveles.
                CG_LOUDNESS(inicio_aplicacion:fin_aplicacion,1) = CG_LOUDNESS(inicio_aplicacion:fin_aplicacion,1)/Ganancia;
            ...
            % Si el LOUDNESS calculado en la ventana es menor que el LOUDNESSnormal.      
            elseif LOUDNESSventana < LOUDNESSnormal
                % Se calcula la diferencia de proporciones de LOUDNESSs, que será 
                % mi Ganancia a aplicar.
                Ganancia = LOUDNESSnormal/LOUDNESSventana;
            ...
            LOUDNESSventana = acousticLoudness(CG_LOUDNESS(inicio_ganancia:fin_ganancia,1), fs);
            % Si el LOUDNESS calculado en la ventana es mayor que el LOUDNESSnormal.
            if LOUDNESSventana > LOUDNESSnormal
                % Se calcula la diferencia de proporciones de LOUDNESSs, que será 
                % mi Ganancia a aplicar.
                Ganancia = LOUDNESSventana/LOUDNESSnormal;
